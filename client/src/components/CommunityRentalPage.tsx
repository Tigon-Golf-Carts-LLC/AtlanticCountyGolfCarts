...
function CommunityRentalPage({ 
  ...
  const pageDescription = `Rent premium golf carts in ${communityName}, Montgomery County, PA. Daily, weekly, monthly rentals available. 4-seater, 6-seater, and utility golf carts. Free delivery in ${communityName}.`;
  ...
  const rentalFeatures = [
    ...
    `Free delivery within ${communityName} area`,
  ...
  const fourSeaterPlans = [
    {
      ...
      delivery: "Free delivery within community limits",
      badge: "POPULAR",
      savings: null
    },
    {
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-theme-orange hover:bg-orange-600 text-white">
                <Link href="tel:1-844-844-6638" className="flex items-center gap-2">
