/**
 * Utility functions for generating Google Maps embed URLs for Montgomery County locations
 */
...
export function generateGoogleMapsEmbed(locationName: string, locationType?: string): string {
  ...
  const fullLocation = locationType 
    ? `${cleanLocationName} ${locationType}, Montgomery County, PA`
    : `${cleanLocationName}, Montgomery County, PA`;
...
export function generateGoogleMapsEmbedLegacy(locationName: string, locationType?: string): string {
  ...
  return `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3048.5!2d-75.25!3d40.25!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2s${encodedLocation}!5e0!3m2!1sen!2sus!4v1653000000000!5m2!1sen!2sus`;
}
