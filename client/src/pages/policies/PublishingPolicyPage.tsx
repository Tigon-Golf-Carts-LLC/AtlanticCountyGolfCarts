...
export default function PublishingPolicyPage() {
  return (
    <>
      <SEOHead 
        title="Publishing Policy | Atlantic County Golf Carts"
        description="Learn about Atlantic County Golf Carts' content publishing standards, guidelines for user-generated content, and editorial policies for our New Jersey website."
        keywords="publishing policy, content policy, Atlantic County golf carts, editorial guidelines"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                Atlantic County Golf Carts maintains high standards for all content published on our website, 
                social media channels, and marketing materials. This policy ensures accuracy, professionalism, 
                and compliance with New Jersey business regulations.
              </p>
