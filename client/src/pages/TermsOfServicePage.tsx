  ...
  return (
    <>
      <SEOHead 
        ...
        description="Terms of Service for Atlantic County Golf Carts. Review our terms and conditions for purchasing golf carts, rental services, and using our website. Call 1-844-844-6638."
        keywords="terms of service, terms and conditions, golf cart purchase, rental agreement, Atlantic County Golf Carts"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="mb-6">
                Welcome to Atlantic County Golf Carts. These Terms of Service ("Terms") govern your use of our website AtlanticCountyGolfCarts.com and your relationship with us regarding the purchase, rental, and servicing of golf carts. By accessing our website or engaging our services, you agree to be bound by these Terms.
              </p>
              ...
              <p className="mb-4">Atlantic County Golf Carts provides:</p>
              <ul className="list-disc pl-6 mb-6">
                <li>New and used golf cart sales</li>
                <li>Golf cart rentals for various durations</li>
                <li>Maintenance and repair services</li>
                <li>Parts and accessories</li>
                <li>Delivery and pickup services throughout Atlantic County, New Jersey</li>
              </ul>
