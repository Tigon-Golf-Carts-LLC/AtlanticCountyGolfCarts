...
export default function EvolutionCarrier6PlusPage() {
  return (
    <VehicleDetailPage
      ...
      seoKeywords="EVOLUTION CARRIER 6 PLUS, utility golf cart, 6-passenger, cargo capacity, Atlantic County, New Jersey"
      canonicalUrl="https://AtlanticCountyGolfCarts.com/vehicles/evolution-carrier-6-plus"
      seats="6"
      range="38 miles"
      topSpeed="25 mph"
      ...
      description="6-passenger utility vehicle with enhanced cargo capacity and work features. The EVOLUTION CARRIER 6 PLUS is designed for both passenger transport and utility work in Atlantic County communities."
