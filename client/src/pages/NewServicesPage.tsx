  ...
  return (
    <>
      <SEOHead 
        ...
        description="Professional golf cart services including maintenance, repair, battery service, and custom modifications. Serving Atlantic County, NJ with certified technicians. Call 1-844-844-6638."
        keywords="golf cart service, golf cart repair, battery replacement, maintenance, Atlantic County"
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-theme-primary to-blue-700 text-white py-20 px-4 bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(14, 46, 85, 0.8), rgba(29, 78, 216, 0.8)), url('/attached_assets/a-photograph-of-a-modern-golf-cart-deale_1Cnk505HSlGhjw-TPLFg9w_nDZV9Dn5QHiGR5OY8JPBgA_1753453234033.png')"}}>
