...
const copyStaticAssets = () => ({
  ...
  closeBundle() {
    ...
    // Copy root-level SEO files into dist so GitHub Pages serves them
    const rootStaticFiles = ["robots.txt", "sitemap.xml"]; // also duplicated in client/public but keep in sync
